...
namespace Fact.Extensions.Caching
{
    public static class ICache_Extensions
    {
        ...
        /// <summary>
        /// Acquire a CachedReference class using an autogenerated key
        /// </summary>
        /// <typeparam name="TValue"></typeparam>
        /// <param name="cache"></param>
        /// <param name="factory"></param>
        ...
        /// <summary>
        /// Acquire a CachedReference class using the specified key and absolute expiry time
        /// </summary>
        /// <typeparam name="TValue"></typeparam>
        /// <param name="cache"></param>
        /// <param name="factory"></param>
        /// <param name="absoluteExpiry"></param>
        public static CachedReferenceAsync<TValue> ReferenceAsync<TValue>(this ICacheAsync cache, string key, Func<Task<TValue>> factory, DateTimeOffset absoluteExpiry)
        {
            return new CachedReferenceAsync<TValue>(cache, key, factory, new AbsoluteTimeExpiration(absoluteExpiry));
        }
        ...
        /// <param name="factory"></param>
        /// <param name="absoluteExpiry"></param>
        public static CachedReferenceAsync<TValue> ReferenceAsync<TValue>(this ICacheAsync cache, string key, Func<Task<TValue>> factory, TimeSpan slidingExpiry)
        {
            return new CachedReferenceAsync<TValue>(cache, key, factory, new SlidingTimeExpiration(slidingExpiry));
        }


        /// <summary>
        /// Acquire a CachedReference class using and autogenerated key and absolute expiry time
        /// </summary>
        /// <typeparam name="TValue"></typeparam>
        /// <param name="cache"></param>
        /// <param name="factory"></param>
        /// <param name="absoluteExpiry"></param>
        /// <returns></returns>
        public static CachedReferenceAsync<TValue> ReferenceAsync<TValue>(this ICacheAsync cache, Func<Task<TValue>> factory, DateTimeOffset absoluteExpiry)
        {
            return cache.ReferenceAsync(factory, new AbsoluteTimeExpiration(absoluteExpiry));
        }


        /// <summary>
        /// Acquire a CachedReference class using and autogenerated key and sliding expiry
        /// </summary>
        /// <typeparam name="TValue"></typeparam>
        /// <param name="cache"></param>
        /// <param name="factory"></param>
        ...
        /// <returns></returns>
        public static CachedReferenceAsync<TValue> ReferenceAsync<TValue>(this ICacheAsync cache, Func<Task<TValue>> factory, TimeSpan slidingExpiry)
        {
            return cache.ReferenceAsync(factory, new SlidingTimeExpiration(slidingExpiry));
        }
    }
}
